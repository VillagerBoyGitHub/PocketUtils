...
namespace pocketmine {
    ...
    const VERSION = "_v2"; //will be set by CI to a git hash
    ...
    $logger->info("Closing other threads...");

    foreach(ThreadManager::getInstance()->getAll() as $id => $thread){
        $logger->debug("Closed " . (new \ReflectionClass($thread))->getShortName() . " thread");
        $thread->quit();
    }
    ...
    echo "The server has stopped successfully." . Terminal::$FORMAT_RESET . "\n";
